...
/*   Updated: 2022/06/26 15:16:56 by fbruggem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_philosopher **philo_create(t_data *data, pthread_mutex_t *forks)
{
	...
	i = 0;
	philosophers = malloc (sizeof(t_philosopher *) * data->number_of_philosophers + 1);
	...
	while (i < data->number_of_philosophers)
	{
		...
		if (i == 0)
			philosophers[i]->fork_left = &forks[philosophers[i]->data->number_of_philosophers -1];
		else
